...
require.define("/app.coffee", function (require, module, exports, __dirname, __filename) {
    (function() {
  var createCollection, data, openPage, setup;
  ...
  openPage = function(name, page) {
    if ((page.find('.sidebar').length)($('body').addClass('with-sidebar'))) {} else {
  ...
  createCollection = function(key) {
    ...
    if (typeof localStorage !== 'undefined') {
      data = localStorage.getItem(key) || void 0;
    }
    try {
...
require.define("/app/data.js", function (require, module, exports, __dirname, __filename) {
